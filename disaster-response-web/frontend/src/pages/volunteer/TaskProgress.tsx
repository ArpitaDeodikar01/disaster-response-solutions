...
import { getTask, updateTaskStatus } from '../../services/firestore';
...
export default function TaskProgress() {
  ...
  async function updateStatus(status: string) {
    ...
    toast.success(status === 'completed' ? 'Task completed! Reliability score updated.' : 'Status updated');
    setUpdating(false);
    if (status === 'completed') navigate('/volunteer');
    else setTask({ ...task, status: status as Task['status'] });
  }
